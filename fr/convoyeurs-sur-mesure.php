...
<meta name="description" content="LM Manutentions fait l'installation de convoyeurs sur mesure. Nous nous adaptons à vos besoins, contactez-nous pour une soumission gratuite"/>
...
<div id="wrapper"><!-- CAROUSEL -->
	<section class="container" style="margin-top: 80px;">
		<div class="row">
			<div class="col-md-6">
				<h2 style="color: #f68b1e;">Convoyeurs sur mesure</h2>
				<h4>Convoyeurs polyvalents et de qualité</h4>
				<hr class="sep" />
